...
login_email = 'ddthang86@gmail.com'
login_password = 'thang186'
...
# NOTE: find_element_by_* has been removed
form = driver.find_element(
    'xpath', '//html/body/content[@class="scrollable"]/div[@class="container page"]/div[@class="form short"]/div[@class="login panel"]/form')
...
coffees = driver.find_element(
    'xpath', '//html/body/header/nav[@id="main"]/div[@class="container"]/div[@class="in"]/a[@href="/coffees"]').click()
time.sleep(10)
...
while True:
    ...
    for i in range(1, 400, 8):
        ...
        # this next line errors out sometimes, maybe it needs more of a time buffer
        time.sleep(2)
        ...
        for tab in tables:
            try:
                t = BeautifulSoup(tab.get_attribute(
